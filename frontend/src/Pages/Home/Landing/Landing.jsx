  ...
  return (
    ...
    {/* Top Section */}
      <div className="top">
        <div className="left">
          <h1>
          Empowering Minds, Inspiring Futures: <br />Your Gateway to Online Learning with <span className="font-semibold text-amber-400 font-serif text-5xl">EurekaPath</span>
          </h1>
          {/*  Search  */}
        ...
        {!loading && facList && (
          ...
          <div key={fac._id} className="bg-[#99afbc] p-5 rounded-md ">
            ...
            { fac.enrolledteacher.Email === "urttsg@gmail.com" ?
              <h4><span className="font-bold text-brown-800">Education :</span> Post graduate from psg University</h4> 
              : 
              <h4><span className="font-bold text-brown-800">Education :</span> Post graduate from psg university</h4>
            }

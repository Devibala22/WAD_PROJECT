...
const approveStudent = asyncHandler(async(req,res)=>{
    ...
    await Sendmail(email, `Document Verification Status`, 
        `<html>
            ...
            <p style="font-size: 16px;"><strong>The EurekaPath Team</strong></p>
            <p style="font-size: 14px;">&copy; 2025 EurekaPath. All rights reserved.</p>
            </body>
        </html>`
    )
    ...
    if(toApprove){
        ...
        Sendmail(req.body.email, `Course Approval Update`, 
            `<html>
                ...
                <p style="font-size: 16px;">Best regards,</p>
                <p style="font-size: 16px;"><strong>The EurekaPath Team</strong></p>
                <p style="font-size: 14px;">&copy; 2024 EurekaPath. All rights reserved.</p>
                </body>
            </html>
        `)
